...
define princess = Character("Princess(?!)", color="#FFA3CA", window_background=Image("gui/textboxes/textbox_pbf.png", style="window"))
...
define pancake = Character("Pancake(?)", color="#4DE5BA", window_background=Image("gui/textboxes/textbox_pbf.png", style="window"))
